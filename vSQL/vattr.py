...
def zmediumtext(default=''):
    return 'MEDIUMTEXT {}'.format(cover(default))


def zblob(default=''):
    return 'BLOB {}'.format(cover(default))


def zmediumblob(default=''):
    return 'MEDIUMBLOB {}'.format(cover(default))
